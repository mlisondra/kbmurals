...
jQuery(document).ready(function() {
		...
		jQuery('#VMmenu".$ID."').hide();
		jQuery('.vm-categories-container').click(
			function() {jQuery('#VMmenu".$ID."').slideToggle('fast')}
		);
	});
//]]>
" ;
...
<div class="vm-categories-container">
<div class="vm-categories-title">Categories</div>
<ul class="categories-list VMmenu<?php echo $class_sfx ?>" id="<?php echo "VMmenu".$ID ?>" >
