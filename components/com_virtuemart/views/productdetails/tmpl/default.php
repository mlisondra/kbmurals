...
if (file_exists (JPATH_ADMINISTRATOR.DS."components".DS."com_virtueupload".DS."classes".DS."output.class.php")) { require_once (JPATH_ADMINISTRATOR.DS."components".DS."com_virtueupload".DS."classes".DS."output.class.php"); }  //add by ym in 2012-2-5
...
//<![CDATA[
	...
	/*	$('.additional-images a').mouseover(function() {
		...
		if($('.crop_button_container').doesExist()) {
			$('.customize_title#crop_image').css('opacity', '1');
		}
	});
...
?>
	...
	<?php echo JText::_('COM_VIRTUEMART_RATING') . ' ' . round($this->rating->rating) . '/' . $maxrating; ?><br/>
		...
		<?php
			// Only include VMUpload if product is in Customize category.
			if ($this->product->category_name == "Customize") {
				include("add_pics.php");//add by ym in 2012-2-5 
				
				echo "<div class='upload_thumbnail_form'>";
				echo "<div id='crop_image' class='customize_title'>";
				echo "<h4>Crop Your Image</h4>";
				echo "</div>";

				if(isset($_SESSION["upload_info"]->id)) {										
					echo "<div class='crop_button_container'>";
					echo "<button type='button' id='rectangle_crop_button' class='crop_button'>Rectangle</button>";
					echo "</div>";
			
					echo "<div class='crop_button_container'>";
					echo "<button type='button' id='square_crop_button' class='crop_button'>Square</button>";
					echo "</div>";
			
					echo "<form name='uploadThumbnail' action='' method='post'>";
					...
					echo "<input type='hidden' name='extension' value='".$_SESSION["file_name_extension"]."' />";
					echo "<input type='hidden' name='filename' value='".$_SESSION["upload_info"]->file_name."' />";
					echo "<input type='hidden' name='width' value='$width' />";
					echo "<input type='hidden' name='height' value='$height' />";
					echo "<input type='submit' name='uploadThumbnail' value='Crop' id='saveThumb' class='button' />";
					echo "</form>";
					echo "</div>";
				}// End if
			}// End if
