...
require JPATH_ADMINISTRATOR.DS.'components'.DS.'com_virtueupload'.DS.'classes' . DS . 'output.class.php' ;   //add by ym in 2012-1-5
echo VUOutput::UploadInfo($this->orderdetails['details']['BT']->virtuemart_order_id,'cart');   //add by ym in 2012-1-5
