...
if (file_exists (JPATH_ADMINISTRATOR.DS."components".DS."com_virtueupload".DS."classes".DS."output.class.php")) { require_once (JPATH_ADMINISTRATOR.DS."components".DS."com_virtueupload".DS."classes".DS."output.class.php"); }  //add by ym in 2012-1-1
/**
 * View for the shopping cart
 * @package VirtueMart
 * @author Max Milbers
