...
// bxSlider for handling carousel in cart.
$document->addScriptDeclaration ("
//<![CDATA[
	jQuery(document).ready(function($) {
		$('.bxslider').bxSlider({
...
<div class="cart-view">
	...
	<div class="sub-title">Accessorize Your Kitchen and Bath</div>
	<?php
		/* Get all Modules assigned to position "KBFeaturedProducts". */
		$myblurb_modules = &JModuleHelper::getModules( "KBFeaturedProducts" );
