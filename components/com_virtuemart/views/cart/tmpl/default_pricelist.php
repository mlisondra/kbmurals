...
?>
<!-- Removed billto-shipto section for KB Murals theme. -->
	<!-- 
...
<table
	...
	width="100%">
<tr>
	<th align="left"><?php echo JText::_ ('COM_VIRTUEMART_CART_ITEM') ?></th>
	<th align="center" width="100px"><?php echo JText::_ ('COM_VIRTUEMART_CART_SKU') ?></th>
	<th
		align="center"
		width="100px"><?php echo JText::_ ('COM_VIRTUEMART_CART_PRICE') ?></th>
	<th
		align="center"
	...
	<th align="center" width="60px"><?php //echo "<span  class='priceColor2'>" . JText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT') ?></th>
...
foreach ($this->cart->products as $pkey => $prow) {
	?>
<tr valign="top" class="sectiontableentry<?php echo $i ?> product-section">
	<td align="left">
		<?php if ($prow->virtuemart_media_id) { ?>
		<span class="cart-images">
						 <?php
			if (!empty($prow->image)) {
				echo $prow->image->displayMediaFull ('', FALSE);
			}
			?>
						</span>
		<?php } ?>
...
<tr class="sectiontableentry1 subtotal-section">
	<td colspan="4" align="left"><?php echo JText::_ ('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_SUBTOTAL'); ?></td>

	<?php if (VmConfig::get ('show_tax')) { ?>
	<td align="center"><?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('taxAmount', '', $this->cart->pricesUnformatted, FALSE) . "</span>" ?></td>
	<?php } ?>
...
if (VmConfig::get ('coupons_enable')) {
	?>
<tr class="sectiontableentry2 coupon-section">
<td colspan="4" align="left">
	...
	?>
					 ...
					 <?php if (VmConfig::get ('show_tax')) { ?>
		<td align="center"><?php echo $this->currencyDisplay->createPriceDiv ('couponTax', '', $this->cart->pricesUnformatted['couponTax'], FALSE); ?> </td>
		<?php } ?>
	<td align="center">&nbsp;</td>
...
<tr class="sectiontableentry1 shipment-section">
...
<tr class="sectiontableentry1 payment-section">
...
<tr class="sectiontableentry2 total-section">
	<td colspan="4" align="left"><strong><?php echo JText::_ ('COM_VIRTUEMART_CART_TOTAL') ?></strong></td>

	<?php if (VmConfig::get ('show_tax')) { ?>
	<td align="center"> <?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('billTaxAmount', '', $this->cart->pricesUnformatted['billTaxAmount'], FALSE) . "</span>" ?> </td>
	<?php } ?>
	...
	<td align="center"><strong><?php echo $this->currencyDisplay->createPriceDiv ('billTotal', '', $this->cart->pricesUnformatted['billTotal'], FALSE); ?></strong></td>
</tr>
<?php
