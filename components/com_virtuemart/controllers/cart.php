...
class VirtueMartControllerCart extends JController {
	...
	public function addJS() {
		...
		if ($cart) {
			...
			if ($cart->add($virtuemart_product_ids, $errorMsg )) {
				...
				$this->json->msg .= '<a class="showcart" href="' . JRoute::_("index.php?option=com_virtuemart&view=cart") . '">' . JText::_('COM_VIRTUEMART_CART_SHOW_MODAL') . '</a>';
	...
	public function viewJS() {
		...
		$this->data->billTotal = $lang->_($this->data->billTotal);
