...
class AiContactSafeViewMessage extends AiContactSafeViewDefault {
	...
	function getTmplHeader() {
		$header = '<form action="'.JURI::root().'index.php?option=com_aicontactsafe" method="post" id="adminForm_'.$this->profile->id.'" name="adminForm_'.$this->profile->id.'" enctype="multipart/form-data"> <fieldset>';
		return $header;
	}
