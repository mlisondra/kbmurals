...
switch($this->profile->align_buttons) {
	case 1:
		...
		$this->buttons = '<div id="aiContactSafeButtons_left" style="clear:both; display:block; width:100%; text-align:left;"><div id="aiContactSafeSend" style="float:left;"><div id="aiContactSafeSend_loading_'.$this->profile->id.'">&nbsp;</div><input type="submit" class="button" id="aiContactSafeSendButton" value="' . JText::_('COM_AICONTACTSAFE_SEND') . '" style="float:left; margin:2px;" /></div>';
		if ($this->back_button) {
...
?>
	...
	?>
		...
		<!-- <div class="aiContactSafe" id="aiContactSafe_info"><strong><?php //echo $_this->contactinformations['required_field_notification']; ?></strong></div> -->
		<?php } ?>
		<?php
