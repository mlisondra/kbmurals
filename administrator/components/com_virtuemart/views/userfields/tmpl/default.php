...
// 			vmdebug('my rows',$row);
			// Commented out thie following code to unlock the Joomla core shopper fields. 
			//This was primarily done to change the requirement of the "agreed" to terms of service (TOS) shopper field to not required. 
			//Now a purchase can be made without requireing shopper to select TOS.
