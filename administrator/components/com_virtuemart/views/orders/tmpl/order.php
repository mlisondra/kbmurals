...
<table width="100%">
	...
	<?php
		...
		?>
			...
			<!--add by ym in 2012-1-5-->
			<?php require JPATH_ADMINISTRATOR.DS.'components'.DS.'com_virtueupload'.DS.'classes' . DS . 'output.class.php' ;//add by ym in 2012-1-5?>
	        <tr> 
	          <td colspan="9" align="left"><? echo VUOutput::UploadInfo ( $this->orderbt->virtuemart_order_id , 'cart' )?></td>
	        </tr>
