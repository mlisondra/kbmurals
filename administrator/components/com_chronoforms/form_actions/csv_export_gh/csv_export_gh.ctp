...
<div class="element_code" id="cfaction_csv_export_gh_element">
	...
	<input type="hidden" name="chronoaction[{n}][action_csv_export_gh_{n}_data_path]" 
		id="action_csv_export_gh_{n}_data_path" value="<?php echo $action_params['data_path']; ?>" />
	...
	<input type="hidden" name="chronoaction[{n}][action_csv_export_gh_{n}_post_file_name]" 
    	id="action_csv_export_gh_{n}_post_file_name" value="<?php echo $action_params['post_file_name']; ?>" />
	...
	<input type="hidden" name="chronoaction[{n}][action_csv_export_gh_{n}_add_titles]" 
    	id="action_csv_export_gh_{n}_add_titles" value="<?php echo $action_params['add_titles']; ?>" />
