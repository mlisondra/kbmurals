...
*
* @version $Id: language.class.php 1388 2008-04-23 17:58:17Z soeren_nb $
* @package VirtueMart
...
//define(ADMINPATH,JPATH_COMPONENT_ADMINISTRATOR."/");  //add by ym

define('ADMINPATH',JPATH_COMPONENT_ADMINISTRATOR."/");  //add by ym
define('DEBUG',false);  //add by ym   in 2011-2-11
